...
namespace Bank.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Edit()
        {
            ...
            if (user != null)
            {
                EditModel model = new EditModel { Firstname = user.Firstname, Secondname = user.Secondname, Thirdname = user.Thirdname, City = user.City, DateOfBirth = user.DateOfBirth, PassportSeries = user.PassportSeries, PassportNumber = user.PassportNumber };
                return View(model);
            }
